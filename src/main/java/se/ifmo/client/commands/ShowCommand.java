...
/**
 * The {@link ShowCommand} class represents a command that displays information about the current collection.
 * This command is used to show all the elements in the collection.
 */
public class ShowCommand extends Command {

    /**
     * Constructs a {@link ShowCommand}.
     * Initializes the command with the name "show" and the description
    ...
    /**
     * Executes the "show" command. This command retrieves and displays all elements in the collection.
