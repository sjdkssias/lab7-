...
public class DragonSQL {
    ...
    public static final String UPDATE_ID = "UPDATE dragon SET name = ?, x = ?, y = ?, speaking = ?, color = ?, character = ?, head = ? WHERE id = ? and owner_name = ?";
    public static final String INSERT = "INSERT INTO dragon (name, x, y, speaking, color, character, head, id, owner_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
}
